    ...
    const LOCALES = {
      pt: {
        ...
        hero_line1:'VENHA SENTIR A DIFERENÇA, PORQUE O CORTE CERTO', hero_line2:'MUDA TUDO.',
        ...
        review1_text:'"FUI MUITO BEM RECEBIDO, EXCELENTE SERVICO, AMBIETE MUITO CONFORTÁVEL, SIMPLESMENTE EXTRAORDINÁRIO"',
        review2_text:'"ANA MINHA CAMINHADA ME DEPAREI COM AH BARBEARIA BALLKUTZ,E ME ENCANTEI BASTANTE ENOVADOR QUE ELA TEM PARA OFERECER PARA NOS JOVEMS. VISITEM ADQUIRE OS SEUS SERVIÇOS...""',
        review3_text:'"UMA EXPERIÊNCIA TOTALMENTE DIFERENTE É COMO SE ESTIVESSE NO PASSADO, PRESENTE E FUTURO AO MESMO TEMPO"',
        review4_text:'"EU ACONSELHO A VIREM NESSA BARBEARIA, ELES RECEBEM MUITO BEM OS CLIENTES E SÃO MUITO GENTES BOA, VIVI UMA BOA EXPERIÊNCIA NESSA BARBEARIA, ATÉ O MEU IRMÃO DE 5 ANOS GOSTOU MUITO. GRAÇAS A ESSA BARBEARIA MEU IRMÃO PEQUENO JOGOU PELA PRIMEIRA VEZ NUMA PLAYSTATION 5"',
      ...
      en: {
        ...
        hero_eyebrow:'Luanda, Angola · Est. 2023',
        hero_line1:'COME FEEL THE DIFFERENCE, BECAUSE THE RIGHT CUT ', hero_line2:'CHANGES EVERYTHING.',
        ...
        review1_text: '"I WAS VERY WELL RECEIVED, EXCELLENT SERVICE, VERY COMFORTABLE ENVIRONMENT, SIMPLY EXTRAORDINARY"',

        review2_text:'"ON MY WALK, I CAME ACROSS BALLKUTZ BARBERSHOP, AND I WAS REALLY IMPRESSED BY HOW INNOVATIVE IT IS AND WHAT IT HAS TO OFFER US YOUNG PEOPLE. VISIT THEM AND TRY THEIR SERVICES..."',

        review3_text:'"A TOTALLY DIFFERENT EXPERIENCE IT IS LIKE BEING IN THE PAST, PRESENT ,AND FUTURE ALL AT THE SAME TIME"',

review4_text:'"I HIGHLY RECOMMEND COMING TO THIS BARBERSHOP; THEY WELCOME CUSTOMERS VERY WELL AND ARE REALLY COOL PEOPLE. I HAD A GREAT EXPERIENCE HERE, AND EVEN MY 5-YEAR-OLD BROTHER LOVED IT. THANKS TO THIS SHOP, MY LITTLE BROTHER GOT TO PLAY ON A PLAYSTATION 5 FOR THE FIRST TIME"',
