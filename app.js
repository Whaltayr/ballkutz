...
const LOCALES = {
  pt: {
    ...
    hero_line1: "VISTA A SUA",
    hero_line2: "NOVA PELE.",
    hero_sub:
    ...
    plan_pro_badge: "Plano PRO",
    plan_pro_limit: "Limitado 2× por mês",
    plan_promax_badge: "Plano PRO MAX",
    plan_promax_limit: "Ilimitados — Quantas vezes quiser",
    plan_cta: "Aderir ao Plano",
    plan_promax_cta: "Aderir ao PRO MAX",
    ...
    review1_text:
      '"Melhor barbearia de Luanda, sem dúvida. O ambiente é incrível, parece que estamos num clube de campeões. O Mário fez um trabalho espetacular no meu fade."',
    review2_text:
      '"Aderi ao plano PRO MAX e vale cada kwanza. Corte perfeito sempre que apareço, sem filas de espera. O Carlos é uma máquina a fazer designs."',
    review3_text:
      '"Levei o meu filho e ficámos os dois super satisfeitos. Espaço limpo, modernos, música boa e ainda tem PlayStation! Voltámos na semana seguinte."',
    review4_text:
      '"Fiz o 24K Gold Limpeza de Pele e a pele ficou renovada. O André é um profissional de excelência. Recomendo a toda a gente que se preocupa com a sua imagem."',
  ...
  en: {
    ...
    plan_pro_badge: "PRO Plan",
    plan_pro_limit: "Limited 2× per month",
    plan_promax_badge: "PRO MAX Plan",
    plan_promax_limit: "Unlimited — As many times as you want",
    plan_cta: "Join the Plan",
    plan_promax_cta: "Join PRO MAX",
    ...
    review1_text:
      '"Best barbershop in Luanda, no doubt. The vibe is incredible, feels like a champions\' club. Mário did a spectacular job on my fade."',
    review2_text:
      '"Joined the PRO MAX plan and it\'s worth every kwanza. Perfect cut every time I show up, no queues. Carlos is a machine at designs."',
    review3_text:
      '"Took my son and we were both super happy. Clean, modern space, great music and they even have PlayStation! We came back the following week."',
    review4_text:
      '"Did the 24K Gold Skin Cleanse and my skin was completely renewed. André is a true professional. I recommend it to anyone who cares about their image."',
...
async function notifyEmail(payload) {
  try {
    await fetch("https://formsubmit.co/ajax/" + CONTACT_EMAIL, {
      ...
      body: JSON.stringify({
        _captcha: "false",
        _subject: "Nova marcação — " + payload.Nome,
        ...payload,
      }),
    });
  } catch (e) {
...
function initYouTubeFacade() {
  ...
  facade.addEventListener("keydown", handleKey);
}
